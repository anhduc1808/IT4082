          ...
          <div className="flex flex-wrap items-center justify-center md:justify-between">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-blueGray-500 font-semibold py-1">
                Copyright © 2024 -{" "}
                <a href="https://github.com/anhduc1808/it4082/">
                  Nhóm 13 - IT3180.
                </a>
              </div>
            </div>
          ...
          <section className="pt-4">
            <div className="container mx-auto px-4">
              <div className="flex flex-wrap justify-center">
                {[
                  {
                    name: "Nguyễn Sỹ Anh Đức",
                    mssv: "20225703",
                    imgSrc: "/img/duc.jpg",
                    social: [{ icon: <Github />, url: "https://github.com/anhduc1808" }],
                  },
                  {
                    name: "Nguyễn Văn Tuấn Tú",
                    mssv: "20225771",
                    imgSrc: "/img/tu.jpg",
                    social: [{ icon: <Github />, url: "https://github.com/NguyenTu-sudo" }],
                  },
                ].map((person, index) => (
                  <div
                    key={index}
